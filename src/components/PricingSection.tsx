      ...
      <div className="container-narrow">
        ...
        <AnimatedSection animation="fade-up" delay={200}>
          <div className="mt-10 rounded-3xl bg-primary/5 border border-primary/10 p-6 md:p-8 text-sm text-text-secondary leading-relaxed">
            <p>
              Указаны базовые цены. Итоговая стоимость рассчитывается
              индивидуально и фиксируется в договоре до начала оказания услуг.
              Возможна оплата в рассрочку. Подробные условия —{" "}
              <a href="/offer" className="text-primary hover:underline">
                в публичной оферте
              </a>
              . Условия возврата средств описаны{" "}
              <a href="/refund" className="text-primary hover:underline">
                в регламенте возврата
              </a>
              .
            </p>
          </div>
