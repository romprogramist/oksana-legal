...
const SITE = "https://списаниедолговфизлиц.рф";
    ...
    <div className="min-h-screen bg-background">
      <div className="container-narrow py-12 md:py-20">
        ...
        <article className="prose prose-gray max-w-3xl">
          <h1>Политика конфиденциальности и пользовательское соглашение</h1>
          <p><strong>{LEGAL.fullName}</strong></p>
          ...
          <p>
            ...
            ИП Абаджян Оксаной Юрьевной (далее — Оператор).
          </p>
          <p>
          ...
          <p>
            ...
            посетителях веб-сайта <a href={SITE}>{SITE}</a>.
          </p>
          ...
          <p>
            ...
            сетевому адресу <a href={SITE}>{SITE}</a>.
          </p>
          <p>
          ...
          <p>
            ...
            определенному или определяемому Пользователю веб-сайта <a href={SITE}>{SITE}</a>.
          </p>
          <p>
          ...
          <p>
            2.10. Пользователь — любой посетитель веб-сайта <a href={SITE}>{SITE}</a>.
          </p>
          <p>
          ...
          <ul>
            <li>
              ...
              персональных данных. Перечень информации и порядок ее получения установлен Законом
          ...
          <ul>
            ...
            <li>5.4. Год, месяц, дата и место рождения.</li>
            <li>5.5. Реквизиты документа, удостоверяющего личность.</li>
            <li>
              5.6. Идентификационный номер налогоплательщика, дата постановки его на учет,
              реквизиты свидетельства постановки на учет в налоговом органе.
            </li>
            <li>
              5.7. Адрес фактического места проживания и регистрации по месту жительства и (или)
              по месту пребывания.
            </li>
            <li>
              5.8. Сведения об образовании, профессии, специальности и квалификации, реквизиты
              документов об образовании.
            </li>
            <li>5.9. Сведения о семейном положении и составе семьи.</li>
            <li>5.10. Сведения об имущественном положении.</li>
            <li>5.11. Сведения о доходах.</li>
            <li>5.12. Сведения о задолженности.</li>
            <li>
              5.13. Сведения о занимаемых ранее должностях и стаже работы, воинской обязанности,
              воинском учете.
            </li>
          </ul>
          <p>
            5.14. Также на сайте происходит сбор и обработка обезличенных данных о посетителях
            (в т.ч. файлов «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика и
            Гугл Аналитика и других).
          </p>
          <p>
            5.15. Вышеперечисленные данные далее по тексту Политики объединены общим понятием
            Персональные данные.
          </p>
          <p>
            5.16. Обработка специальных категорий персональных данных, касающихся расовой,
          ...
          <p>
            5.17. Обработка персональных данных, разрешенных для распространения, из числа
            специальных категорий персональных данных, указанных в ч. 1 ст. 10 Закона о
            персональных данных, допускается, если соблюдаются запреты и условия, предусмотренные
            ст. 10.1 Закона о персональных данных.
          </p>
          <p>
            5.18. Согласие Пользователя на обработку персональных данных, разрешенных для
          ...
          <p>
            5.18.1. Согласие на обработку персональных данных, разрешенных для распространения,
            Пользователь предоставляет Оператору непосредственно.
          </p>
          <p>
            5.18.2. Оператор обязан в срок не позднее трех рабочих дней с момента получения
            указанного согласия Пользователя опубликовать информацию об условиях обработки, о
            наличии запретов и условий на обработку неограниченным кругом лиц персональных
            данных, разрешенных для распространения.
          </p>
          <p>
            5.18.3. Передача (распространение, предоставление, доступ) персональных данных,
          ...
          <p>
            5.18.4. Согласие на обработку персональных данных, разрешенных для распространения,
            прекращает свое действие с момента поступления Оператору требования, указанного в
            п. 5.18.3 настоящей Политики в отношении обработки персональных данных.
          </p>
          ...
          <p>
            ...
            которому является субъект персональных данных. Обрабатываемые персональные данные
          ...
          <ul>
            ...
            <li>
              ...
              содержащимся на веб-сайте <a href={SITE}>{SITE}</a>;
            </li>
            <li>
              рекламно-информационные материалы компании под брендом ИП Абаджян Оксана Юрьевна.
            </li>
          </ul>
          <p>
            ...
            <a href={CONTACT.emailHref}>{CONTACT.email}</a> с пометкой «Отказ от уведомлений о
          ...
          <ul>
            ...
            <li>
              ...
              персональных данных, разрешённых для распространения.
            </li>
          </ul>
          <p>
            ...
            расположенные на сайте <a href={SITE}>{SITE}</a> или направленные Оператору
            посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои
          ...
          <p>
            ...
            электронной почты Оператора <a href={CONTACT.emailHref}>{CONTACT.email}</a> с
          ...
          <p>
            ...
            адрес Оператора <a href={CONTACT.emailHref}>{CONTACT.email}</a> с пометкой «Отзыв
          ...
          <p>
            ...
            электронной почты <a href={CONTACT.emailHref}>{CONTACT.email}</a>.
          </p>
          <p>
          ...
          <p>
            ...
            адресу <a href={SITE}>{SITE}</a>.
          </p>

          <h2>Реквизиты Оператора</h2>
          <p>
            Индивидуальный предприниматель: {LEGAL.fullName}
            <br />
            ИНН: {LEGAL.inn}
            <br />
            ОГРНИП: {LEGAL.ogrnip}
            ...
            <br />
            Электронная почта: <a href={CONTACT.emailHref}>{CONTACT.email}</a>
          </p>
        </article>
      </div>
    </div>
